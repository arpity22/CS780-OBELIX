...
class DuelingDQN(nn.Module):
    ...
    which action to take, leading to faster and more stable learning.
    """
...
def policy(obs: np.ndarray, rng: np.random.Generator) -> str:
    ...
    Args:
        obs: Current observation (18-dim sensor readings)
        rng: Random number generator (unused during greedy evaluation)
    
    Returns:
        Action string from ACTIONS list
    """
    ...
    # This reduces oscillation/jitter when multiple actions seem equally good
